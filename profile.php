		...
		<h2><?= $user->email; ?></h2>
			<div id="profile-content">
				...
				<div id="profile-picture-note">
						...
						<br> <br>
						But if you want your Picture to always show in your profile, send your picture to this whatsapp no: <ins><strong>09052757805</strong></ins>. You will pay small cash for that, and changes will be made instantly.<br> <br> For every other comments/messages/complain, click <a href="contact.php">HERE</a> to send your messages.</p>
				</div>
			</div> 
